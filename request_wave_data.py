...
def main():
    ...
    # Base request parameters for waves
    request = {
        "variable": [
            "mean_wave_direction",
            "mean_wave_period",
    ...
    output_dir = base_dir / config['output']['directory'] / config['output']['data']['wave']
    output_dir.mkdir(parents=True, exist_ok=True)
    filename = output_dir / generate_filename('wave_data', frequency, start_date, end_date, bounds)
